...
```{R basic}
library(lazysf)
f <- system.file("extdata/north-carolina-counties.gpkg", package = "lazysf", mustWork = TRUE)
...
```{r Geopackage-SQLite}
library(lazysf)
gpkgfile <- system.file("extdata/north-carolina-counties.gpkg", package = "lazysf", mustWork = TRUE)
