...
GDAL. It uses
[`gdalraster::GDALVector`](https://firelab.github.io/gdalraster/reference/GDALVector-class.html)
to talk to GDAL and `dbplyr` for SQL translation, giving you lazy
evaluation of spatial data through familiar dplyr verbs.
...
Use [`show_query()`](https://dplyr.tidyverse.org/reference/explain.html)
to see the SQL:
